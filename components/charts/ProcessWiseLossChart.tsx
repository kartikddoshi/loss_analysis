...
import { getProcessWiseLoss } from '@/lib/analysisQueries'
...
const ProcessWiseLossChart: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg mb-8">
      <h2 className="text-2xl font-semibold mb-4 text-gray-700 dark:text-gray-200">Process-wise Loss</h2>
...
export default ProcessWiseLossChart
